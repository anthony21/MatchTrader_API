...
ARCHIVE_ROOT = "matchtrader-python/v1"
TREES = {"src", "tests", "scripts", "docs", ".agents", "frontend"}
SUFFIXES = {".py", ".md", ".json", ".yaml", ".yml", ".js", ".vue", ".css", ".html"}
EXCLUDED = {
    "__pycache__",
    ".pytest_cache",
    ".ruff_cache",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=Path, default=Path("dist/matchtrader-v1-handoff.zip"))
